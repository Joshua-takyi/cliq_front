...
const Hero = () => {
  return (
    <section className="relative bg-[url('https://images.pexels.com/photos/414727/pexels-photo-414727.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')] bg-cover bg-center lg:h-[60dvh] h-[80dvh] flex items-center justify-center">
